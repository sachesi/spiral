...
folder" and the portal backend. Thumbnailers, the reader of file details for the details
panel, archive tools and the PDF previewer run under bubblewrap, which is required: they
read files from anywhere, and Spiral has no unsandboxed path for them.
