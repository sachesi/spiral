...
Grid and list views, tabs, a places sidebar with devices and bookmarks, background file
...
Search only filters the open folder, tabs are not restored between runs, and there are no
translations yet.
