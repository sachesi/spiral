...
libadwaita, libseccomp and GStreamer; running needs the GStreamer base plugins and the
GTK 4 sink (`gstreamer1-plugin-gtk4` on Fedora) for the media preview. Details, other
