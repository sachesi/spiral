...
## Where things are
    ...
    src/folder_model.rs    list model of a folder: sorting, filtering, the selection kept
                           through changes; in folder_model/ the listing and its monitor,
                           searching, and Favorites and tags as lists
    ...
    src/dialogs/           preferences, properties (a file per page in properties/), open
                           with, compress, folder chooser, and the Space preview, with its
                           sizing, viewers and loading in preview/
