...
The column view draws the path as a strip of lists, one folder per column.
...
Trash and Favorites. Cut, copy and paste use the usual clipboard format for files, so
