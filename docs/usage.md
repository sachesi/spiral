...
them in the background; middle-clicking a sidebar entry opens it in a new tab too. The
last tab closing closes the window. Window size is remembered, tabs are not.
...
Favorites. Cut, copy and paste use the usual clipboard format for files, so they
work with other file managers. "Paste Into Folder" pastes into a selected folder without entering it.
