...
Ctrl+? shows this list inside the application.
...
of a PDF, Ctrl++, Ctrl+- and Ctrl+0 zoom a picture or a page, Return opens the file in its
application, and Space or Esc closes the preview.
