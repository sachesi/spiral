...
# The preview colours the source code it shows.
...
# What decodes the files people have: libav carries most of the decoders, the
# parsers in bad-free feed them, and H.264 needs OpenH264, whose repository is
# not always enabled.
...
Recommends:     glycin-libs%{?_isa}
Recommends:     glycin-loaders%{?_isa}
Suggests:       7zip
